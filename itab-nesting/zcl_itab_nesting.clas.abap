...
CLASS zcl_itab_nesting IMPLEMENTATION.
  ...
  METHOD perform_nesting.
       nested_data = VALUE #( FOR <ls_artist> IN artists ( artist_id   = <ls_artist>-artist_id
                                                           artist_name = <ls_artist>-artist_name
                                                           albums      = VALUE #( FOR <ls_albums> IN albums WHERE ( artist_id = <ls_artist>-artist_id )
                                                                                ( album_id = <ls_albums>-album_id
                                                                                  album_name = <ls_albums>-album_name
                                                                                  songs = VALUE #( FOR <ls_songs> IN songs WHERE ( artist_id = <ls_artist>-artist_id AND album_id = <ls_albums>-album_id  )
